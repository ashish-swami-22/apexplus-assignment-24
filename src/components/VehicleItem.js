...
function VehicleItem(props) {
    ...
    return (
        <tr>
            ...
            <VehicleEdit name={props.vehicle.name} speed={props.vehicle.speed} positionX={props.vehicle.positionX} positionY={props.vehicle.positionY} direction={props.vehicle.direction} onClose={() => setShowEditModal(false)} show={showEditModal} handleSave={editVehicle} />
        </tr>
    )
}
