...
import ScenarioBtn from './ScenarioBtn';
...
function AllScenarios() {
    ...
    if (scenarios.length > 0) {
        return (
            <div className="main-container">
                <ScenarioBtn cls={'button orange-btn'} delete={confirmDelete} clsTxt={''} />
    ...
    return (
        <div className="main-container">
            <ScenarioBtn cls={'isInvisible'} delete={null} clsTxt={'isInvisible'} />
